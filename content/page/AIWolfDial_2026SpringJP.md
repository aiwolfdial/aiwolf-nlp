...
- **2026/03/22**: グループチャット形式（リアルタイムシステム）による人狼大会を新たに開始予定です。対応サーバ・雛形エージェント・ビューアは4月中を目処に公開予定です。詳細は[レギュレーション](/menu/AIWolfDial2026_SpringJp/regulation#グループチャットモード新方式)・[開発](/menu/AIWolfDial2026_SpringJp/agent#グループチャットモードへの対応)をご確認ください。
