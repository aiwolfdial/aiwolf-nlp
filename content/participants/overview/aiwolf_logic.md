...
draft: false
title: '人狼知能大会のゲームロジックの実装'
category: participants_guide
---

このページでは、人狼知能大会におけるゲームロジックの実装について説明します。\
ここで指すゲームロジックとは、本大会の人狼ゲームのルールならびにその遂行に関わる処理全般を指します。
...
発言の文字数が0であった場合は、overに置換します。

---

以上で人狼知能大会におけるゲームロジックの説明を完了します。
