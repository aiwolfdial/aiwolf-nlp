...
No separate final is held. From the Main Competition results, top teams are selected based on subjective evaluation and win rate, and the Main Competition logs of matches played among those teams are extracted and treated as the de facto final.
...
- **July 4, 2026**: Registration / connection check deadline for "Round 1 + Round 2" teams (2 days before the Round 1 Main Competition)
...
- **August 1, 2026**: Registration / connection check deadline for "Round 2 only" teams (2 days before the Round 2 Main Competition)
